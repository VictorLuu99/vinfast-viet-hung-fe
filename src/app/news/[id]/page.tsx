...
import { apiClient, NewsArticle, formatDate, vietnameseNewsCategories } from '@/lib/api';
import { Calendar, ArrowLeft, Share2, Facebook, Twitter, Copy, Check } from 'lucide-react';
...
export default function NewsArticlePage() {
  ...
  const fetchArticle = async () => {
    ...
    try {
      const response = await apiClient.getNewsArticle(articleId);
  ...
  const fetchRelatedArticles = async (category: string) => {
    try {
      ...
      if (response.success && response.data) {
        ...
        const filtered = response.data.filter(a => a.id.toString() !== articleId);
          ...
          <div className="max-w-4xl mx-auto">
            ...
            <div className="mb-8">
              <div className="flex items-center gap-4 mb-6">
                <CategoryBadge category={getCategoryLabel(article.category)} />
            ...
            <div className="bg-gradient-to-r from-blue-600 to-green-600 rounded-lg p-8 text-white text-center mb-12">
              <h3 className="text-2xl font-bold mb-4">Quan tâm đến xe điện VinFast?</h3>
              <p className="text-lg opacity-90 mb-6">
                Liên hệ với VinFast Việt Hùng để được tư vấn chi tiết và trải nghiệm xe
              </p>
