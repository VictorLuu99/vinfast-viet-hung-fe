...
export default function RecruitmentPageClient() {
  ...
  const fetchJobs = async () => {
    ...
    try {
      ...
      const response: ApiResponse<JobPosting[]> = await apiClient.getJobs(params);
        ...
        <div className="container mx-auto px-4">
          <div className="text-center">
            ...
            <p className="text-xl md:text-2xl opacity-90 max-w-3xl mx-auto">
              Gia nhập đội ngũ VinFast Việt Hùng - Cùng phát triển sự nghiệp trong ngành ô tô điện tương lai
            </p>
          </div>
        </div>
      </section>
            ...
            <div className="flex flex-col lg:flex-row lg:items-center lg:justify-between gap-4">
              ...
              <div className="text-gray-600">
                <span className="flex items-center">
                  ...
                  {isLoading ? 'Đang tải...' : `${totalItems} vị trí việc làm`}
                </span>
              </div>
            </div>
          </div>
        ...
        <div className="container mx-auto px-4">
          <div className="text-center mb-12">
            ...
            <p className="text-xl text-gray-600 max-w-3xl mx-auto">
              Chúng tôi cam kết tạo ra môi trường làm việc tốt nhất cho nhân viên
            </p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
            <div className="text-center">
              ...
              <p className="text-gray-600">Làm việc với công nghệ xe điện hàng đầu</p>
            </div>
            ...
            <div className="text-center">
              ...
              <h3 className="text-lg font-semibold text-gray-900 mb-2">Phát triển sự nghiệp</h3>
              <p className="text-gray-600">Cơ hội thăng tiến và học hỏi không ngừng</p>
            </div>
            ...
            <div className="text-center">
              ...
              <h3 className="text-lg font-semibold text-gray-900 mb-2">Thu nhập hấp dẫn</h3>
              <p className="text-gray-600">Mức lương cạnh tranh và thưởng hiệu suất</p>
            </div>
            ...
            <div className="text-center">
              ...
              <h3 className="text-lg font-semibold text-gray-900 mb-2">Phúc lợi tốt</h3>
              <p className="text-gray-600">Bảo hiểm đầy đủ và các chế độ đãi ngộ</p>
            </div>
          </div>
        </div>
      </section>
