...
import { apiClient, JobPosting, formatDate, vietnameseJobCategories } from '@/lib/api';
import { Calendar, MapPin, Clock, Users, ArrowLeft, Send, Building, DollarSign, CheckCircle } from 'lucide-react';
  ...
  const fetchRelatedJobs = async (department: string) => {
    try {
      ...
      if (response.success && response.data) {
        ...
        const filtered = response.data.filter(j => j.id.toString() !== jobId);
      ...
      <section className="bg-gray-100 py-4">
        <div className="container mx-auto px-4">
          <nav className="flex items-center space-x-2 text-sm text-gray-600">
            ...
            <span>/</span>
            <Link href="/recruitment" className="hover:text-blue-600">Tuyển dụng</Link>
            <span>/</span>
        ...
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto">
              ...
              <div className="lg:col-span-2">
                ...
                <div className="mb-8">
                  <div className="flex items-center gap-4 mb-6">
                    <CategoryBadge category={getCategoryLabel(job.department)} />
                  ...
                  {!applicationSubmitted ? (
                    ...
                    <div className="bg-green-50 border border-green-200 rounded-lg p-6 text-center">
                      ...
                      <p className="text-green-700">
                        Chúng tôi đã nhận được đơn ứng tuyển của bạn và sẽ liên hệ sớm nhất.
                      </p>
                    </div>
                  )}
            ...
            {relatedJobs.length > 0 && (
              <div className="mt-16">
                <h2 className="text-2xl font-bold text-gray-900 mb-6">Vị trí liên quan</h2>
                <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                  {relatedJobs.map((relatedJob) => (
                    <Link
                      key={relatedJob.id}
                      href={`/recruitment/${relatedJob.id}`}
                    ...
                    >
                      <div className="p-6">
                        ...
                        <div className="text-sm text-gray-500 mb-2">
                          {relatedJob.location} • {getJobTypeLabel(relatedJob.job_type || relatedJob.employment_type)}
                        </div>
